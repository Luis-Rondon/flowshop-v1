...
function TooltipButtonTitle() {
  ...
  return (
    <button type="button" className="btn p-0" style={{ width: '12px', height: '12px', backgroundColor: 'transparent', border: 'none' }} data-bs-toggle="tooltip" data-bs-placement="top" title="Este título identificará tu proyecto en el panel de administración, y generará el título para tu publicación." data-bs-custom-class="custom-tooltip">
...
export default TooltipButtonTitle;
