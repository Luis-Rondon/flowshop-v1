...
function TooltipButtonNet() {
  ...
  return (
    <button type="button" className="btn p-0" style={{ width: '12px', height: '12px', backgroundColor: 'transparent', border: 'none' }} data-bs-toggle="tooltip" data-bs-placement="top" title="Elige la red social para la cual estás generando contenido." data-bs-custom-class="custom-tooltip">
...
export default TooltipButtonNet;
