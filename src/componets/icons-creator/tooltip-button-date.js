...
function TooltipButtonDate() {
  ...
  return (
    <button type="button" className="btn p-0" style={{ width: '12px', height: '12px', backgroundColor: 'transparent', border: 'none' }} data-bs-toggle="tooltip" data-bs-placement="top" title="Selecciona la fecha y hora cuando quieres que tu creación sea subida a tu red social. (La fecha debe ser confirmada nuevamente cuando el post esté creado)." data-bs-custom-class="custom-tooltip">
...
export default TooltipButtonDate;
